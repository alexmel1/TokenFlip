      ...
      {isConnected ? (
        <div style={{ width: '100%', maxWidth: '400px', padding: '40px', background: 'rgba(15, 23, 42, 0.8)', borderRadius: '32px', border: '1px solid #1e293b', textAlign: 'center' }}>
          ...
          <Transaction chainId={8453} calls={calls}>
            <TransactionButton text="Start Duel" style={{ width: '100%', padding: '15px', borderRadius: '12px', background: '#3b82f6', border: 'none', color: 'white', fontWeight: 'bold', fontSize: '1rem', cursor: 'pointer' }} />
            <TransactionStatus>
